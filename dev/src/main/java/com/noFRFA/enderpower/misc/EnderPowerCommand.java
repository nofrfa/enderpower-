...
public class EnderPowerCommand extends CommandBase {
	public static final String
			...
			USAGE = "/enderpower_give <detter_shulker or detter_enderfish>",//Шаблон вызова, выводится при выбрасывании WrongUsageException
	...
	public List<String> getTabCompletions(MinecraftServer server, ICommandSender sender, String[] args, @Nullable BlockPos targetPos) {
		if (args.length == 1)
			return getListOfStringsMatchingLastWord(args, new String[]{"detter_shulker", "detter_enderfish"});
		else return null;
	}
