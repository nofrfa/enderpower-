...
public class MatterSemiFluidsTE extends TileEntityInventory implements IHasGui, IUpgradableBlock, IMultiEnergySource, INetworkClientTileEntityEventListener, ISemiFluidFuelManager {
    ...
    @Override
    public boolean sendMultipleEnergyPackets() { return (double)this.generation - EnergyNet.instance.getPowerFromTier(this.tier) > 0.0D; }

    @Override
    public int getMultipleEnergyPacketAmount() { return (int)Math.round((double) this.generation); }
